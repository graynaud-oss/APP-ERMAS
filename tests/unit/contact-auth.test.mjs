...
test('le garde précède les actions, la carte et l’affichage', () => {
    ...
    assert.ok(listenerPosition < mapPosition);
...
test('la carte historique est conservée mais chargée seulement après autorisation', () => {
